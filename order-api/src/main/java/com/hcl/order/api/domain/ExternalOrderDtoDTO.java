...
public class ExternalOrderDtoDTO implements Serializable {
	public List<com.hcl.order.api.domain.ExternalOrderPaymentDetailDTO> getExternalOrderPaymentDetailDTOs() {
		return externalOrderPaymentDetailDTOs;
	}

	private List<com.hcl.order.api.domain.ExternalOrderPaymentDetailDTO> externalOrderPaymentDetailDTOs = new ArrayList<com.hcl.order.api.domain.ExternalOrderPaymentDetailDTO>();

	public void setExternalOrderPaymentDetailDTOs(List<com.hcl.order.api.domain.ExternalOrderPaymentDetailDTO> externalOrderPaymentDetailDTOs) {
		this.externalOrderPaymentDetailDTOs = externalOrderPaymentDetailDTOs;
	}

	public List<com.hcl.order.api.domain.ExternalOrderDetailDTO> getExternalOrderDetailDTOs() {
		return externalOrderDetailDTOs;
	}

	private List<com.hcl.order.api.domain.ExternalOrderDetailDTO> externalOrderDetailDTOs = new ArrayList<com.hcl.order.api.domain.ExternalOrderDetailDTO>();

	public void setExternalOrderDetailDTOs(List<com.hcl.order.api.domain.ExternalOrderDetailDTO> externalOrderDetailDTOs) {
		this.externalOrderDetailDTOs = externalOrderDetailDTOs;
	}

	public List<com.hcl.order.api.domain.ExternalCouponDTO> getExternalCouponDTOs() {
		return externalCouponDTOs;
	}

	private List<com.hcl.order.api.domain.ExternalCouponDTO> externalCouponDTOs = new ArrayList<com.hcl.order.api.domain.ExternalCouponDTO>();

	public void setExternalCouponDTOs(List<com.hcl.order.api.domain.ExternalCouponDTO> externalCouponDTOs) {
