 ...
 */
public class ExternalOrderDtoVO implements Serializable {
	public List<com.hcl.canceltrx.model.ExternalOrderPaymentDetailVO> getExternalOrderPaymentDetailVOs() {
		return externalOrderPaymentDetailVOs;
	}

	private List<com.hcl.canceltrx.model.ExternalOrderPaymentDetailVO> externalOrderPaymentDetailVOs = new ArrayList<com.hcl.canceltrx.model.ExternalOrderPaymentDetailVO>();

	public void setExternalOrderPaymentDetailVOs(List<com.hcl.canceltrx.model.ExternalOrderPaymentDetailVO> externalOrderPaymentDetailVOs) {
		this.externalOrderPaymentDetailVOs = externalOrderPaymentDetailVOs;
	}

	public List<com.hcl.canceltrx.model.ExternalOrderDetailVO> getExternalOrderDetailVOs() {
		return externalOrderDetailVOs;
	}

	private List<com.hcl.canceltrx.model.ExternalOrderDetailVO> externalOrderDetailVOs = new ArrayList<com.hcl.canceltrx.model.ExternalOrderDetailVO>();

	public void setExternalOrderDetailVOs(List<com.hcl.canceltrx.model.ExternalOrderDetailVO> externalOrderDetailVOs) {
		this.externalOrderDetailVOs = externalOrderDetailVOs;
	}

	public List<com.hcl.canceltrx.model.ExternalCouponVO> getExternalCouponVOs() {
		return externalCouponVOs;
	}

	private List<com.hcl.canceltrx.model.ExternalCouponVO> externalCouponVOs = new ArrayList<com.hcl.canceltrx.model.ExternalCouponVO>();

	public void setExternalCouponVOs(List<com.hcl.canceltrx.model.ExternalCouponVO> externalCouponVOs) {
		this.externalCouponVOs = externalCouponVOs;
	}
