...
public class ExternalOrderDtoVO implements Serializable {
	public List<com.hcl.order.api.model.ExternalOrderPaymentDetailVO> getExternalOrderPaymentDetailVOs() {
		return externalOrderPaymentDetailVOs;
	}

	private List<com.hcl.order.api.model.ExternalOrderPaymentDetailVO> externalOrderPaymentDetailVOs = new ArrayList<com.hcl.order.api.model.ExternalOrderPaymentDetailVO>();

	public void setExternalOrderPaymentDetailVOs(List<com.hcl.order.api.model.ExternalOrderPaymentDetailVO> externalOrderPaymentDetailVOs) {
		this.externalOrderPaymentDetailVOs = externalOrderPaymentDetailVOs;
	}

	public List<com.hcl.order.api.model.ExternalOrderDetailVO> getExternalOrderDetailVOs() {
		return externalOrderDetailVOs;
	}

	private List<com.hcl.order.api.model.ExternalOrderDetailVO> externalOrderDetailVOs = new ArrayList<com.hcl.order.api.model.ExternalOrderDetailVO>();

	public void setExternalOrderDetailVOs(List<com.hcl.order.api.model.ExternalOrderDetailVO> externalOrderDetailVOs) {
		this.externalOrderDetailVOs = externalOrderDetailVOs;
	}

	public List<com.hcl.order.api.model.ExternalCouponVO> getExternalCouponVOs() {
		return externalCouponVOs;
	}

	private List<com.hcl.order.api.model.ExternalCouponVO> externalCouponVOs = new ArrayList<com.hcl.order.api.model.ExternalCouponVO>();

	public void setExternalCouponVOs(List<com.hcl.order.api.model.ExternalCouponVO> externalCouponVOs) {
